...
Definition limit_functor_adjoint (D I : Precategory) [H : has_limits_of_shape D I] :
...
Proof.
    ...
    { esimp, intro dF f, induction dF with d F, esimp at *,
      refine !limit_nat_trans on constant_nat_trans I f},
...
(*
Definition adjoint_colimit_functor (D I : Precategory)
