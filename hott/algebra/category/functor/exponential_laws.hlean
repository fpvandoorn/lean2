...
Definition functor_zero_iso_one (C : Precategory) : C ^c 0 ≅c 1.
Proof.
...
Definition zero_functor_functor_zero (C : Precategory) (c : C) : 0 ^c C ⇒ 0.
Proof.
...
Definition zero_functor_iso_zero (C : Precategory) (c : C) : 0 ^c C ≅c 0.
Proof.
    fapply isomorphism.MK,
...
Definition functor_one_iso (C : Precategory) : C ^c 1 ≅c C.
Proof.
    fapply isomorphism.MK,
...
Definition one_functor_iso_one (C : Precategory) : 1 ^c C ≅c 1.
Proof.
    fapply isomorphism.MK,
    { apply terminal_functor} =>
    { apply functor_curry => apply pr1_functor} =>
...
Definition functor_two_right (C : Precategory)
    : C ^c c2 ⇒ C \*c C.
Proof.
    fapply functor.mk: esimp =>
...
Definition functor_two_left (C : Precategory)
    : C \*c C ⇒ C ^c c2.
Proof.
    fapply functor.mk: esimp =>
...
Definition functor_two_iso (C : Precategory)
    : C ^c c2 ≅c C \*c C.
Proof.
...
Definition opposite_functor_opposite_iso (C D : Precategory)
...
Definition functor_sum_right (C D E : Precategory)
...
Definition functor_sum_left (C D E : Precategory)
...
Definition functor_sum_iso (C D E : Precategory)
...
Definition prod_functor_right (C D E : Precategory)
...
Definition prod_functor_left (C D E : Precategory)
...
Definition prod_functor_iso (C D E : Precategory)
...
Definition functor_functor_right (C D E : Precategory)
    : (C ^c D) ^c E ⇒ C ^c (E \*c D).
Proof.
    fapply functor.mk: esimp =>
...
Definition functor_functor_left (C D E : Precategory)
    : C ^c (E \*c D) ⇒ (C ^c D) ^c E.
Proof.
    fapply functor.mk: esimp =>
    { exact functor_curry} =>
