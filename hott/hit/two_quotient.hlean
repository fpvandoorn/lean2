...
open quotient eq circle sum sigma equiv function relation e_closure
  ...
  e : forall {a a' : A}, R a a' -> a = a' (for some (type-valued) relation R on A)
...
namespace simple_two_quotient
  ...
  parameter  (Q : forall (a), T a a -> Type)
  ...
  | pre_Rmk {} : forall (a a') (r : R a a'), pre_two_quotient_rel (inl a) (inl a')
...
Definition pre_two_quotient . quotient pre_two_quotient_rel
  ...
  protectedDefinition j (a : A) : C . class_of pre_two_quotient_rel (inl a)
  protectedDefinition pre_aux (q : Q r) : C.
  class_of pre_two_quotient_rel (inr ⟨a, r, q⟩)
  protectedDefinition e (s : R a a') : j a = j a' . eq_of_rel _ (pre_Rmk s)
  protectedDefinition et (t : T a a') : j a = j a' . e_closure.elim e t
  protectedDefinition f (q : Q r) : S¹ -> C.
  circle.elim (j a) (et r)

  protectedDefinition pre_rec {P : C -> Type}
  (Pj : forall a, P (j a)) (Pa : forall (a : A) (r : T a a) (q : Q r), P (pre_aux q))
  (Pe : forall (a a' : A) (s : R a a'), Pj a =[e s] Pj a') (x : C) : P x.
Proof.
  induction x with p,
  { induction p,
  { apply Pj},
...
Defined.
  ...
  protectedDefinition pre_elim {P : Type} (Pj : A -> P)
  (Pa : forall (a : A) (r : T a a), Q r -> P) (Pe : forall (a a' : A) (s : R a a'), Pj a = Pj a') (x : C)
  : P.
  pre_rec Pj Pa (fun a a' s => pathover_of_eq _ (Pe s)) x

  protectedDefinition rec_e {P : C -> Type}
  (Pj : forall a, P (j a)) (Pa : forall (a : A) (r : T a a) (q : Q r), P (pre_aux q))
  (Pe : forall (a a' : A) (s : R a a'), Pj a =[e s] Pj a') (a a' : A) (s : R a a')
  : apd (pre_rec Pj Pa Pe) (e s) = Pe s.
  !rec_eq_of_rel

  protectedDefinition elim_e {P : Type} (Pj : A -> P) (Pa : forall (a : A) (r : T a a), Q r -> P)
  (Pe : forall (a a' : A) (s : R a a'), Pj a = Pj a') (a a' : A) (s : R a a')
...
Defined.
  ...
  protectedDefinition elim_et {P : Type} (Pj : A -> P) (Pa : forall (a : A) (r : T a a), Q r -> P)
  (Pe : forall (a a' : A) (s : R a a'), Pj a = Pj a') (a a' : A) (t : T a a')
  : ap (pre_elim Pj Pa Pe) (et t) = e_closure.elim Pe t.
  ap_e_closure_elim_h e (elim_e Pj Pa Pe) t

  protectedDefinition rec_et {P : C -> Type}
  (Pj : forall a, P (j a)) (Pa : forall (a : A) (r : T a a) (q : Q r), P (pre_aux q))
  (Pe : forall (a a' : A) (s : R a a'), Pj a =[e s] Pj a') (a a' : A) (t : T a a')
  ...
  | Rmk {} : forall {a : A} {r : T a a} (q : Q r) (x : circle),
...
Definition incl0 (a : A) : D . i (j a)
  protectedDefinition aux (q : Q r) : D . i (pre_aux q)
...
Definition inclt (t : T a a') : incl0 a = incl0 a' . e_closure.elim incl1 t
  ...
  protectedDefinition incltw (t : T a a') : incl0 a = incl0 a' . ap i (et t)

  protectedDefinition inclt_eq_incltw (t : T a a') : inclt t = incltw t.
  (ap_e_closure_elim i e t)^-1

Definition incl2' (q : Q r) (x : S¹) : i (f q x) = aux q.
  eq_of_rel simple_two_quotient_rel (Rmk q x)

  protectedDefinition incl2w (q : Q r) : incltw r = idp.
  (ap02 i (elim_loop (j a) (et r))^-1) @
  (ap_compose i (f q) loop)^-1 @
...
Definition incl2 (q : Q r) : inclt r = idp.
  ...
  parameters {R Q}
  protectedDefinition rec {P : D -> Type} (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a : A) (r : T a a) (q : Q r),
...
Proof.
  ...
  do 2 (transitivity _; exact !change_path_con^-1),
  transitivity _, apply ap (change_path _),
  exact (to_left_inv (change_path_equiv _ _ (incl2 q)) _)^-1, esimp,
  rewrite P2, transitivity _; exact !change_path_con^-1, apply ap (fun x => change_path x _),
  rewrite [↑incl2, con_inv], transitivity _, exact (concat_pp_p _ _ _)^-1,
...
Defined.
  ...
  protectedDefinition rec_on {P : D -> Type} (x : D) (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a : A) (r : T a a) (q : Q r),
  change_path (incl2 q) (e_closure.elimo incl1 P1 r) = idpo) : P x.
  rec P0 P1 P2 x

Definition rec_incl1 {P : D -> Type} (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a : A) (r : T a a) (q : Q r),
...
Definition rec_inclt {P : D -> Type} (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a : A) (r : T a a) (q : Q r),
  ...
  protectedDefinition elim {P : Type} (P0 : A -> P)
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a : A) (r : T a a) (q : Q r), e_closure.elim P1 r = idp)
  (x : D) : P.
Proof.
  induction x,
  ...
  !elim_et @
  P2 q @
  (ap_pp _ _ _)stant^-1 end} end end},
Defined.
  local attribute elim [unfold 8]

  protectedDefinition elim_on {P : Type} (x : D) (P0 : A -> P)
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a : A) (r : T a a) (q : Q r), e_closure.elim P1 r = idp)
  : P.
  elim P0 P1 P2 x
...
Definition elim_incl1 {P : Type} {P0 : A -> P}
  ...
  (ap_compose (elim P0 P1 P2) i (e s))^-1 @ !elim_e
...
Definition elim_inclt {P : Type} {P0 : A -> P}
  ...
  protectedDefinition elim_incltw {P : Type} {P0 : A -> P}
  {P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a'}
  (P2 : forall (a : A) (r : T a a) (q : Q r), e_closure.elim P1 r = idp)
  (a a' : A) (t : T a a') : ap (elim P0 P1 P2) (incltw t) = e_closure.elim P1 t.
  (ap_compose (elim P0 P1 P2) i (et t))^-1 @ !elim_et

  protectedDefinition elim_inclt_eq_elim_incltw {P : Type} {P0 : A -> P}
  {P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a'}
  (P2 : forall (a : A) (r : T a a) (q : Q r), e_closure.elim P1 r = idp)
  (a a' : A) (t : T a a')
...
Proof.
  ...
  xrewrite [eq_of_square (ap_ap_e_closure_elim i (elim P0 P1 P2) e t)^-1ʰ],
  rewrite [↓incl1,con.assoc], apply whisker_left,
  rewrite [↑[elim_et,elim_incl1],+ap_e_closure_elim_h_eq,con_inv,↑[i,function.compose]] =>
  rewrite [-con.assoc (_ @ _),con.assoc _^-1,con.left_inv,▸*,-ap_inv,-ap_con],
  apply ap (ap _),
...
Definition elim_incl2' {P : Type} {P0 : A -> P}
  ...
  protectedDefinition elim_incl2w {P : Type} (P0 : A -> P)
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a : A) (r : T a a) (q : Q r), e_closure.elim P1 r = idp)
  (a : A) (r : T a a) (q : Q r)
...
Proof.
  ...
  ((ap_compose_natural (elim P0 P1 P2) i (elim_loop (j a) (et r)))^-1ʰ^-1ᵛ @h
  (ap_ap_compose (elim P0 P1 P2) i (f q) loop)^-1ʰ^-1ᵛ @h
  ap_ap_is_constant (elim P0 P1 P2) (incl2' q) loop @h
  ap_con_right_inv_sq (elim P0 P1 P2) (incl2' q base)),
  ↑[elim_incltw]],
  apply whisker_tl,
  rewrite [ap_is_constant_eq],
  xrewrite [naturality_apd_eq (fun x => !elim_eq_of_rel) loop],
  ...
  apply eq_vconcat,
  { apply ap (fun x => _ @ eq_con_inv_of_con_eq ((_ @ x @ _)^-1 @ _) @ _),
  ...
  whisker_right_con_whisker_left _ (ap_pp _ _ _)stant],
  xrewrite [-con.assoc _ _ (whisker_right _ _)],
  rewrite [con.assoc _ _ (whisker_left _ _),idp_con_whisker_left,▸*,
  con.assoc _ (ap_pp _ _ _)stant^-1,con.left_inv],
  xrewrite [eq_con_inv_of_con_eq_whisker_left,▸*],
  rewrite [+con.assoc _ _ (con_pV _),
  right_inv_eq_idp (
  (fun (x : ap (elim P0 P1 P2) (incl2' q base) = idpath
  ...
  rewrite [con.left_inv,▸*,-+con.assoc,con.assoc _^-1,↑[elim,function.compose] =>con.left_inv,
...
namespace two_quotient
  ...
  (R : A -> A -> Type)
  local abbreviation T . e_closure R (* the (type-valued) equivalence closure of R *)
  parameter  (Q : forall (a a'), T a a' -> T a a' -> Type)
  variables (a a' a'' : A) {s : R a a'} {t t' : T a a'}

  inductive two_quotient_Q : forall (a : A), e_closure R a a -> Type.
  | Qmk : forall (a a' : A) (t t' : T a a'), Q t t' -> two_quotient_Q (t @r t'^-1ʳ)
  open two_quotient_Q
...
Definition incl2 (q : Q t t') : inclt t = inclt t'.
  ...
  parameters {R Q}
  protectedDefinition rec {P : two_quotient -> Type} (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'),
...
Proof.
  ...
  refine ap (fun x => change_path _ (_ @o x)) !change_path_invo @ _, esimp,
  apply cono_invo_eq_idpo, apply P2 end end}
Defined.

  protectedDefinition rec_on {P : two_quotient -> Type} (x : two_quotient)
  (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'),
  change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t') : P x.
  rec P0 P1 P2 x

Definition rec_incl1 {P : two_quotient -> Type} (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'),
  change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
...
Definition rec_inclt {P : two_quotient -> Type} (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'),
  change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
  ...
  protectedDefinition elim {P : Type} (P0 : A -> P)
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
  (x : two_quotient) : P.
Proof.
  induction x,
  { exact P0 a},
...
Defined.
  ...
  protectedDefinition elim_on {P : Type} (x : two_quotient) (P0 : A -> P)
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
  : P.
  elim P0 P1 P2 x
...
Proof.
  ...
  con.left_inv,↑whisker_left,con2_con_con2,-con.assoc (ap_inv _ _)^-1,
...
Definition elim_inclt_inv [unfold_full] {P : Type} {P0 : A -> P}
  ...
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
  (a a' : A) (t : T a a')
  : elim_inclt P2 t^-1ʳ = ap_inv (elim P0 P1 P2) (inclt t) @ (elim_inclt P2 t)⁻².
  idp
...
Definition inclt_inv [unfold_full] (t : T a a') : inclt t^-1ʳ = (inclt t)^-1 . idp
Definition inclt_con [unfold_full] (t : T a a') (t' : T a' a'')
  : inclt (t @r t') = inclt t @ inclt t' . idp
Defined.
Defined. two_quotient
...
Definition incl2w (q : Q t t') : incltw t = incltw t'.
  ap02 tr (!incl2 q)
Definition incl2 (q : Q t t') : inclt t = inclt t'.
  !ap_e_closure_elim^-1 @ ap02 tr (!incl2 q) @ !ap_e_closure_elim
...
Definition is_trunc_trunc_two_quotient [instance] : is_trunc n trunc_two_quotient . _
  ...
  protectedDefinition rec {P : trunc_two_quotient -> Type} [H : forall x, is_trunc n (P x)]
  (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'),
  change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
...
Defined.
  ...
  protectedDefinition rec_on {P : trunc_two_quotient -> Type} [H : forall x, is_trunc n (P x)]
...
Definition rec_incl1 {P : trunc_two_quotient -> Type} [H : forall x, is_trunc n (P x)]
  (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'),
  change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
...
Definition rec_inclt {P : trunc_two_quotient -> Type} [H : forall x, is_trunc n (P x)]
  (P0 : forall (a : A), P (incl0 a))
  (P1 : forall (a a' : A) (s : R a a'), P0 a =[incl1 s] P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'),
  change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
  ...
  protectedDefinition elim {P : Type} (P0 : A -> P) [H : is_trunc n P]
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
...
Defined.
  ...
  protectedDefinition elim_on {P : Type} [H : is_trunc n P] (x : trunc_two_quotient) (P0 : A -> P)
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
  : P.
  elim P0 P1 P2 x
...
Definition elim_incl2 {P : Type} [H : is_trunc n P] (P0 : A -> P)
  (P1 : forall (a a' : A) (s : R a a'), P0 a = P0 a')
  (P2 : forall (a a' : A) (t t' : T a a') (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
  (a a' : A) (t t' : T a a') (q : Q t t')
  : square (ap02 (elim P0 P1 P2) (incl2 q)) (P2 q) (elim_inclt P2 t) (elim_inclt P2 t').
Proof.
  ...
  note H7 . eq_top_of_square (Ht^-1ʰ @h Hn^-1ᵛ @h Ht'), clear [Hn, Ht, Ht'],
  ...
  have H : forall (t : T a a'),
  ap_e_closure_elim (elim P0 P1 P2) (fun a a' (r : R a a') => ap tr (two_quotient.incl1 R Q r)) t @
  (ap_e_closure_elim_h (two_quotient.incl1 R Q)
  (fun a a' (s : R a a') => ap_compose (elim P0 P1 P2) tr (two_quotient.incl1 R Q s)) t)^-1 @
