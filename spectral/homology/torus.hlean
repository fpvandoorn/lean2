...
Definition Hptorus : forall (n : ℤ)(m : ℕ), HH theory n (plift (sphere m \** sphere m)) <~>g
  HH theory n (plift (sphere m)) \*g (HH theory n (plift (sphere m)) \*g HH theory n (plift (sphere (m + m)))) . fun n m =>
  calc        HH theory n (plift (sphere m \** sphere m))
  <~>g HH theory (n + 1) (plift (⅀ (sphere m \** sphere m))) : by exact (Hplift_susp theory n (sphere m \** sphere m))^-1ᵍ
